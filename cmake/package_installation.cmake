...
if(NOT EMSCRIPTEN)
	...
	if(EXISTS ${CMAKE_BINARY_DIR}/${PACKAGE_EXE_NAME}.worker.js)
		install(FILES ${CMAKE_BINARY_DIR}/${PACKAGE_EXE_NAME}.worker.js DESTINATION ${RUNTIME_INSTALL_DESTINATION})
	endif()
